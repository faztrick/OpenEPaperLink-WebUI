...
bool IRInterface::sendProfileCommand(IRCommandType commandType) {
    ...
    switch (commandType) {
        case IR_CMD_POWER: code = currentProfile.powerCode; break;
        case IR_CMD_VOLUME_UP: code = currentProfile.volumeUpCode; break;
        case IR_CMD_VOLUME_DOWN: code = currentProfile.volumeDownCode; break;
        case IR_CMD_CHANNEL_UP: code = currentProfile.channelUpCode; break;
        case IR_CMD_CHANNEL_DOWN: code = currentProfile.channelDownCode; break;
        case IR_CMD_MUTE: code = currentProfile.muteCode; break;
        case IR_CMD_MENU: code = currentProfile.menuCode; break;
        case IR_CMD_OK: code = currentProfile.okCode; break;
        case IR_CMD_BACK: code = currentProfile.backCode; break;
        case IR_CMD_HOME: code = currentProfile.homeCode; break;
        case IR_CMD_UP: code = currentProfile.upCode; break;
        case IR_CMD_DOWN: code = currentProfile.downCode; break;
        case IR_CMD_LEFT: code = currentProfile.leftCode; break;
        case IR_CMD_RIGHT: code = currentProfile.rightCode; break;
        default:
...
IRProtocolType IRInterface::decodeTypeToProtocol(decode_type_t type) {
    switch (type) {
        case NEC: return IR_PROTOCOL_NEC;
        case SAMSUNG: return IR_PROTOCOL_SAMSUNG;
        case SONY: return IR_PROTOCOL_SONY;
        case LG: return IR_PROTOCOL_LG;
        case RC5: return IR_PROTOCOL_RC5;
        case RC6: return IR_PROTOCOL_RC6;
        case PANASONIC: return IR_PROTOCOL_PANASONIC;
        default: return IR_PROTOCOL_UNKNOWN;
    }
}
...
String IRInterface::protocolToString(IRProtocolType protocol) {
    switch (protocol) {
        ...
        case IR_PROTOCOL_RC6: return "RC6";
        case IR_PROTOCOL_PANASONIC: return "Panasonic";
        case IR_PROTOCOL_RAW: return "Raw";
        default: return "Unknown";
    }
}
...
String IRInterface::getCommandName(IRCommandType commandType) {
    switch (commandType) {
        case IR_CMD_POWER: return "Power";
        case IR_CMD_VOLUME_UP: return "Volume Up";
        case IR_CMD_VOLUME_DOWN: return "Volume Down";
        case IR_CMD_CHANNEL_UP: return "Channel Up";
        case IR_CMD_CHANNEL_DOWN: return "Channel Down";
        case IR_CMD_MUTE: return "Mute";
        case IR_CMD_MENU: return "Menu";
        case IR_CMD_OK: return "OK";
        case IR_CMD_BACK: return "Back";
        case IR_CMD_HOME: return "Home";
        case IR_CMD_UP: return "Up";
        case IR_CMD_DOWN: return "Down";
        case IR_CMD_LEFT: return "Left";
        case IR_CMD_RIGHT: return "Right";
        case IR_CMD_CUSTOM: return "Custom";
        default: return "Unknown";
    }
}
