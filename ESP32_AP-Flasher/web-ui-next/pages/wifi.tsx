...
export default function WifiPage() {
  ...
  return (
    <Layout title="Wi-Fi" description="Wi-Fi configuration">
      <h2>Wi-Fi</h2>
      <p style={{ fontSize: 12, opacity: .7, marginTop: -4 }}>Standard device API Scan below. For direct serial scan <Link href="/serial-wifi" style={{ textDecoration: 'underline' }}>open Serial WiFi page</Link> or append <code>?serial=1</code> to view inline.</p>
