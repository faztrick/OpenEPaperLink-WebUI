...
String rc522CardTypeToString(RC522CardType type) {
    return rc522Interface.getCardTypeName(type);
}
...
RC522CardType stringToRC522CardType(const String& str) {
    ...
    if (str == "MIFARE 4K") return CARD_TYPE_MIFARE_4K;
    if (str == "MIFARE Ultralight") return CARD_TYPE_MIFARE_UL;
    if (str == "MIFARE Plus") return CARD_TYPE_MIFARE_PLUS;
    if (str == "MIFARE DESFire") return CARD_TYPE_MIFARE_DESFIRE;
    if (str == "TNP3XXX") return CARD_TYPE_TNP3XXX;
    if (str == "ISO 14443-4") return CARD_TYPE_ISO_14443_4;
    if (str == "ISO 18092") return CARD_TYPE_ISO_18092;
    if (str == "MIFARE Classic") return CARD_TYPE_MIFARE_CLASSIC;
    return CARD_TYPE_UNKNOWN;
}
